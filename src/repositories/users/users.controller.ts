  ...
  async updateUserSelection(
    ...
    try {
      return await this.BullMqUpdateSelectionService.addJobWithResponse({
        ...
        selectedWagon: newSelection.selectedWagon,
        selectedRoad: newSelection.selectedRoad,
        selectedSlideObstacle: newSelection.selectedSlideObstacle,
        selectedJumpObstacle: newSelection.selectedJumpObstacle,
      });
    } catch (error) {
      throw new BadRequestException('Ошибка при обновлении настроек');
    }
